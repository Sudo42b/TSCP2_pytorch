...
# ICASSP'22 Training Strategies for Improved Lip-Reading; 
# ICASSP'21 Towards Practical Lipreading with Distilled and Efficient Models; 
    ...
    def __init__(self, n_inputs, n_outputs, kernel_size, stride, dilation, padding, relu_type, dwpw=False):
        ...
        if dwpw:
            ...
            self.non_lin = nn.PReLU(num_parameters=n_outputs) \
                if relu_type == 'prelu' else nn.SiLU if relu_type == 'swish' else nn.ReLU()
